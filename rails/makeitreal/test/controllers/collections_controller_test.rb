...
class CollectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection" do
    assert_difference('Collection.count') do
      post collections_url, params: { collection: { end_date: @collection.end_date, season: @collection.season } }
    end
  ...
  test "should update collection" do
    patch collection_url(@collection), params: { collection: { end_date: @collection.end_date, season: @collection.season } }
